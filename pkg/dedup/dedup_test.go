	...
	hashOrig := HashMD5(gopacket.NewPacket(
		buildPacketIPv4(v4params{
			pktParams: pktParams{
				...
				destMac:  net.HardwareAddr{0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xAA},
				srcPort:  29999,
				destPort: 80,
				ttl:      13,
				csum:     uint16(12379),
	...
	hashIdentical := HashMD5(gopacket.NewPacket(
		buildPacketIPv4(v4params{
			pktParams: pktParams{
				srcIP:    net.IP{127, 0, 0, 1},
				destIP:   net.IP{8, 8, 8, 8},
				srcMAC:   net.HardwareAddr{0xFF, 0xAA, 0xFA, 0xAA, 0xFF, 0xBD},
	...
	hashDiffIP := HashMD5(gopacket.NewPacket(
		buildPacketIPv4(v4params{
			pktParams: pktParams{
				...
				srcMAC:   net.HardwareAddr{0xFF, 0xAA, 0xFA, 0xAA, 0xFF, 0xAA},
				destMac:  net.HardwareAddr{0xBD, 0xBD, 0xBD, 0xBD, 0xBD, 0xFF},
				srcPort:  30000,
				destPort: 80,
				ttl:      99,
				csum:     uint16(7893),
